...
around 'ffi_subs_data' => sub ($orig, $self, @args){
    return +{
        ...
        'PyThread_GetInfo' => [ [ 'void' ] => 'PyObject*' ],
        'PyThread_ReInitTLS' => [ [ 'void' ] => 'void' ],
        ...
        'PyThread_allocate_lock' => [ [ 'void' ] => 'PyThread_type_lock' ],
        'PyThread_create_key' => [ [ 'void' ] => 'int' ],
        ...
        'PyThread_get_stacksize' => [ [ 'void' ] => 'size_t' ],
        'PyThread_get_thread_ident' => [ [ 'void' ] => 'unsigned long' ],
        'PyThread_get_thread_native_id' => [ [ 'void' ] => 'unsigned long' ],
        'PyThread_init_thread' => [ [ 'void' ] => 'void' ],
        'PyThread_release_lock' => [ [ 'PyThread_type_lock' ] => 'void' ],
        'PyThread_set_key_value' => [ [ 'int', 'void *' ] => 'int' ],
        'PyThread_set_stacksize' => [ [ 'size_t' ] => 'int' ],
        'PyThread_tss_alloc' => [ [ 'void' ] => 'Py_tss_t *' ],
